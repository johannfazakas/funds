...
class FundRepository(
    ...
    suspend fun list(userId: UUID): List<Fund> = withSuspendingSpan {
        blockingTransaction {
            FundTable
                .selectAll()
    ...
    suspend fun findById(userId: UUID, fundId: UUID): Fund? = withSuspendingSpan {
        blockingTransaction {
            FundTable
                .selectAll()
    ...
    suspend fun findByName(userId: UUID, name: FundName): Fund? = withSuspendingSpan {
        blockingTransaction {
            FundTable
                .selectAll()
    ...
    suspend fun save(userId: UUID, request: CreateFundTO): Fund = withSuspendingSpan {
        blockingTransaction {
    ...
    suspend fun deleteById(userId: UUID, fundId: UUID): Unit = withSuspendingSpan {
        blockingTransaction {
