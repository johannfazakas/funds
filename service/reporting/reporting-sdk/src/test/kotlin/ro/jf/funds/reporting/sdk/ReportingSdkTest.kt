        ...
        val expectedResponse = ExpenseReportDataTO(
            ...
            data = listOf(
                ExpenseReportDataTO.DataItem(
                    ...
                    startValue = BigDecimal("210.0"),
                    endValue = BigDecimal("200.0"),
                ...
                ExpenseReportDataTO.DataItem(
                    ...
                    startValue = BigDecimal("310.0"),
                    endValue = BigDecimal("300.0"),
                ...
                ExpenseReportDataTO.DataItem(
                    ...
                    startValue = BigDecimal("410.0"),
                    endValue = BigDecimal("400.0"),
                                ...
                                expectedResponse.data.forEach { item ->
                                    add(
                                        buildJsonObject {
                                            ...
                                            put("startValue", JsonPrimitive(item.startValue.toString()))
                                            put("endValue", JsonPrimitive(item.endValue.toString()))
