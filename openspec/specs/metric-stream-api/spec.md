...
Defines the streaming metrics endpoint of the analytics service: SSE event protocol (buckets, per-query value events, terminal complete/error), consistency with the aggregate report endpoint, and validation and failure semantics.
