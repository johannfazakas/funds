# Grouped Interest Rate Report

## Purpose

Defines the grouped interest rate report capability, supporting per-fund, per-account, per-financial-unit, and per-category interest rate breakdowns.
