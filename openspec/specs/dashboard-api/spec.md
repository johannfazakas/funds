...
Defines the analytics service's per-user dashboard endpoints: persistence and retrieval of dashboards with their charts, dashboard and chart lifecycle operations, ordering, and validation with per-user isolation.
