# Ungrouped Interest Rate Report

## Purpose

Defines the interest rate report endpoint, calculation methodology, and ungrouped behavior for computing time-weighted investment returns.
